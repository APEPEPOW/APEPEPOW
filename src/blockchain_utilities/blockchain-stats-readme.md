# APEPEPOW Blockchain Stats

APEPEPOW Blockchain Stats utlity exports daily statistics for the apepepow blockchain from creation through current state.

## Usage:

See also the utility's help option. `apepepow-blockchain-stats --help`
...
- `apepepow-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `apepepow-blockchain-stats | save-to-database.sh`
