...
* Running apepepow node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/apepepowexamples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/apepepow/testnet_pvt```. 
