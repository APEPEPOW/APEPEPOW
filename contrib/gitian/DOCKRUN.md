...
*Setup instructions for a Gitian build of APEPEPOW using Docker.*
...
You'll also need to clone the apepepow repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/apepepow-project/apepepow.git
cd apepepow/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/apepepow-project/gitian.sigs/) repo on your GitHub account.
