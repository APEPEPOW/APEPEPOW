...
RUN	git clone https://github.com/apepepow-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/apepepow-project/apepepow
...
if [ ! -d sigs ]; then
	git clone https://github.com/apepepow-project/gitian.sigs.git sigs
	cd sigs
